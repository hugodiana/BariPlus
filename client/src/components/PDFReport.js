...
const styles = StyleSheet.create({
    ...
    header: { fontSize: 10, marginBottom: 20, textAlign: 'center', color: 'grey' },
    title: { fontSize: 22, textAlign: 'center', marginBottom: 10, fontFamily: 'Helvetica-Bold' },
    subtitle: { fontSize: 14, textAlign: 'center', marginBottom: 25 },
    chartImage: { width: '100%', height: 'auto', marginBottom: 20 },
    ...
    tableColHeader: { width: "25%", borderStyle: "solid", borderWidth: 1, borderColor: '#bfbfbf', borderLeftWidth: 0, borderTopWidth: 0, backgroundColor: '#f2f2f2', padding: 6 },
    tableCol: { width: "25%", borderStyle: "solid", borderWidth: 1, borderColor: '#bfbfbf', borderLeftWidth: 0, borderTopWidth: 0, padding: 6 },
    tableCellHeader: { fontSize: 11, fontFamily: 'Helvetica-Bold' },
    tableCell: { fontSize: 9 },
    footer: { position: 'absolute', bottom: 30, left: 0, right: 40, textAlign: 'center', color: 'grey', fontSize: 10 },
});
        ...
        <Page size="A4" style={styles.page}>
            ...
            <View style={styles.table}>
                <View style={styles.tableRow}>
                    ...
                    <View style={styles.tableColHeader}><Text style={styles.tableCellHeader}>Braço D. (cm)</Text></View>
                    <View style={styles.tableColHeader}><Text style={styles.tableCellHeader}>Braço E. (cm)</Text></View>
                </View>
